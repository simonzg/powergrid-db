...
export class AssetMovement {
  ...
  @Column({
    type: 'binary',
    length: 20,
    transformer: fixedBytes(20, 'move.sender'),
  })
  ...
  @Column({
    type: 'binary',
    length: 20,
    transformer: fixedBytes(20, 'move.recipient'),
  })
  ...
  @Column({
    type: 'binary',
    length: 32,
    transformer: fixedBytes(32, 'move.blockID'),
  })
  ...
  @Column({
    type: 'binary',
    length: 32,
    transformer: fixedBytes(32, 'move.txID'),
  })
  @Index()
  public txID!: string;
  ...
  @OneToMany(
    ...
    (aggregated) => aggregated.movement,
    { cascade: ['insert'] }
  )
